...
impl ByteCompiler<'_> {
    pub(crate) fn generator_next(&mut self, value: &Register, resume_kind: &Register) {
        ...
        self.bytecode_emitter.emit_throw(value.variable());
    ...
    pub(crate) fn generator_delegate_next(
        ...
        self.bytecode_emitter.emit_call(1u8.into());
        self.bytecode_emitter.emit_push_true(is_return.variable());
        ...
        self.push_from_register(value);
        self.bytecode_emitter.emit_call(1u8.into());
        self.bytecode_emitter.emit_push_false(is_return.variable());
        self.pop_into_register(value);
